...
public class DatabaseConfig {
	...
	private Properties hibProperties() {
		...
		properties.put(PROPERTY_NAME_c3P0_IDLE_TEST_PERIOD,
				env.getRequiredProperty(PROPERTY_NAME_c3P0_IDLE_TEST_PERIOD));
		properties.put(PROPERTY_NAME_c3P0_ACQUIRE_INCREMENT,
				env.getRequiredProperty(PROPERTY_NAME_c3P0_ACQUIRE_INCREMENT));
		return properties;
	}

...
@Controller
@RequestMapping(value="/heroNotSubscribed")
public class HeroNotSubscribedController {
	...
	public ModelAndView listOfHeroes() {
		ModelAndView modelAndView = new ModelAndView("heroNotSubscribed-list");
		
		List<Hero> heroes = heroService.getNotSubscribedHeroes();

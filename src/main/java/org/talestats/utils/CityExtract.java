...
public class CityExtract {
	public Integer getSize(String str) {
		if ((str.substring(str.indexOf("Размер города") + 15, str.indexOf("Размер города") + 16).matches("[0-9]"))
				&& (str.substring(str.indexOf("Размер города") + 16, str.indexOf("Размер города") + 17).matches("[0-9]"))) {
